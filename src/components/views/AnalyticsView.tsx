...
export const AnalyticsView: React.FC = () => {
  ...
  return (
    <div className="space-y-4 sm:space-y-6 pb-24 sm:pb-20 max-w-5xl mx-auto font-sans animate-fade-in">
      ...
      <div className="p-3.5 sm:p-6 rounded-2xl sm:rounded-3xl bg-white dark:bg-[#18181D] border border-[#E2E8F0] dark:border-[#272730] shadow-xs sm:shadow-subtle-depth">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-4">
          ...
          <div className="flex items-center gap-2 self-start sm:self-auto shrink-0">
            <span className="inline-flex items-center gap-1.5 px-2.5 sm:px-3 py-1 sm:py-1.5 rounded-lg sm:rounded-xl bg-amber-500/10 dark:bg-amber-500/15 text-amber-600 dark:text-amber-400 border border-amber-500/25 text-[11px] sm:text-xs font-mono font-black">
      ...
      <div className="p-3.5 sm:p-5 rounded-2xl sm:rounded-3xl bg-white dark:bg-[#18181D] border border-[#E2E8F0] dark:border-[#272730] shadow-xs sm:shadow-subtle-depth space-y-2.5 sm:space-y-3.5 relative overflow-hidden">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2.5 sm:gap-3">
          <div className="flex items-center gap-2.5 sm:gap-3">
            <div className="w-9 h-9 sm:w-11 sm:h-11 rounded-xl sm:rounded-2xl bg-gradient-to-br from-amber-500 to-yellow-600 text-black flex items-center justify-center font-bold shadow-md shadow-amber-500/20 shrink-0 border border-white/20">
              <Zap className="w-4 h-4 sm:w-5 sm:h-5 fill-current stroke-[2.2]" />
            </div>
            <div>
              <h3 className="text-xs sm:text-base font-black text-[#11120F] dark:text-[#F5F5F7] uppercase tracking-tight">
                Level {profile.level} • {profile.levelTitle}
              </h3>
              <p className="text-[10px] sm:text-xs text-[#65675F] dark:text-[#94A3B8] font-medium line-clamp-1 sm:line-clamp-none">
          ...
          <div className="flex items-center gap-2 self-start sm:self-auto shrink-0">
            <span className="text-[11px] sm:text-xs font-mono font-black text-amber-600 dark:text-amber-400 tabular-nums px-2 sm:px-2.5 py-0.5 sm:py-1 rounded-lg sm:rounded-xl bg-amber-500/10 border border-amber-500/20">
              {profile.xp} / {xpMax} XP
            </span>
          </div>
        </div>
        ...
        <div className="space-y-1">
          <div className="w-full h-2 sm:h-3 rounded-full bg-[#E2E8F0] dark:bg-[#13141C] overflow-hidden p-0.5 border border-[#E2E8F0]/50 dark:border-[#252736]/50">
            <div
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-2.5 sm:gap-4">
        ...
        <div className="group relative p-3.5 sm:p-5 rounded-2xl sm:rounded-3xl bg-white dark:bg-[#18181D] border border-[#E2E8F0] dark:border-[#272730] hover:border-cyan-500/50 shadow-xs sm:shadow-subtle-depth space-y-2 sm:space-y-3 transition-all duration-200 overflow-hidden">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-1.5 sm:gap-2 text-cyan-600 dark:text-cyan-400">
              <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-lg sm:rounded-xl bg-cyan-500/15 flex items-center justify-center border border-cyan-500/25">
                <Target className="w-3.5 h-3.5 sm:w-4 sm:h-4 stroke-[2.4]" />
              </div>
              <span className="text-[10px] sm:text-[11px] font-black uppercase tracking-wider font-mono">Readiness Score</span>
            </div>
            
            <span className={`px-1.5 sm:px-2 py-0.5 rounded-md sm:rounded-lg text-[9px] sm:text-[10px] font-mono font-black border ${
              readinessScore >= 75
          ...
          <div className="space-y-0.5">
            <h3 className="text-xl sm:text-3xl font-black text-[#11120F] dark:text-[#F5F5F7] font-mono tabular-nums leading-none">
              {readinessScore} <span className="text-xs font-sans text-[#85877E] font-bold">/ 100</span>
            </h3>
            <p className="text-[10px] sm:text-[11px] text-[#65675F] dark:text-[#94A3B8] font-medium pt-0.5 sm:pt-1">
        ...
        <div className="group relative p-3.5 sm:p-5 rounded-2xl sm:rounded-3xl bg-white dark:bg-[#18181D] border border-[#E2E8F0] dark:border-[#272730] hover:border-emerald-500/50 shadow-xs sm:shadow-subtle-depth space-y-2 sm:space-y-3 transition-all duration-200 overflow-hidden">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-1.5 sm:gap-2 text-emerald-600 dark:text-emerald-400">
              <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-lg sm:rounded-xl bg-emerald-500/15 flex items-center justify-center border border-emerald-500/25">
                <CheckCircle2 className="w-3.5 h-3.5 sm:w-4 sm:h-4 stroke-[2.4]" />
              </div>
              <span className="text-[10px] sm:text-[11px] font-black uppercase tracking-wider font-mono">Practice Accuracy</span>
            </div>

            <span className="px-1.5 sm:px-2 py-0.5 rounded-md sm:rounded-lg text-[9px] sm:text-[10px] font-mono font-black bg-emerald-500/15 text-emerald-600 dark:text-emerald-400 border border-emerald-500/25">
              Recall Quality
            </span>
          </div>

          <div className="space-y-0.5">
            <h3 className="text-xl sm:text-3xl font-black text-emerald-600 dark:text-emerald-400 font-mono tabular-nums leading-none">
        ...
        <div className="group relative p-3.5 sm:p-5 rounded-2xl sm:rounded-3xl bg-white dark:bg-[#18181D] border border-[#E2E8F0] dark:border-[#272730] hover:border-purple-500/50 shadow-xs sm:shadow-subtle-depth space-y-2 sm:space-y-3 transition-all duration-200 overflow-hidden">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-1.5 sm:gap-2 text-purple-600 dark:text-purple-400">
              <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-lg sm:rounded-xl bg-purple-500/15 flex items-center justify-center border border-purple-500/25">
                <Award className="w-3.5 h-3.5 sm:w-4 sm:h-4 stroke-[2.4]" />
              </div>
              <span className="text-[10px] sm:text-[11px] font-black uppercase tracking-wider font-mono">Badges Unlocked</span>
            </div>

            <span className="px-1.5 sm:px-2 py-0.5 rounded-md sm:rounded-lg text-[9px] sm:text-[10px] font-mono font-black bg-purple-500/15 text-purple-600 dark:text-purple-400 border border-purple-500/25">
      ...
      {currentExam && currentExam.subjects.length > 0 && (
        <div className="p-3.5 sm:p-5 rounded-2xl sm:rounded-3xl bg-white dark:bg-[#18181D] border border-[#E2E8F0] dark:border-[#272730] shadow-xs sm:shadow-subtle-depth space-y-2.5 sm:space-y-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-1.5 sm:gap-2 text-[10px] sm:text-xs font-mono font-bold text-[#65675F] dark:text-[#A1A1AA] uppercase tracking-wider">
              <Layers className="w-3.5 h-3.5 text-cyan-400" />
              <span>Subject Preparedness Distribution</span>
            </div>
            <span className="text-[10px] sm:text-[11px] font-mono text-[#85877E]">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-2.5">
            {currentExam.subjects.map(s => {
              ...
              return (
                <div
                  key={s.id}
                  className="p-2.5 sm:p-3 rounded-xl sm:rounded-2xl bg-[#F8FAFC] dark:bg-[#14151F] border border-[#E2E8F0] dark:border-[#242533] space-y-1.5 sm:space-y-2"
                >
                  <div className="flex items-center justify-between gap-1.5">
                    <div className="flex items-center gap-1.5 min-w-0">
                      <SubjIcon className="w-3.5 h-3.5 shrink-0" style={{ color }} />
                      <span className="text-[11px] sm:text-xs font-bold text-[#11120F] dark:text-white truncate">
                        {s.name}
                      </span>
                    </div>
                    <span className="text-[10px] sm:text-[11px] font-mono font-black text-cyan-500 tabular-nums">
                      {percent}%
                    </span>
                  </div>

                  <div className="w-full h-1 sm:h-1.5 rounded-full bg-[#E2E8F0] dark:bg-[#20212E] overflow-hidden">
                    <div
      ...
      <div className="space-y-3 sm:space-y-4">
        <div className="flex items-center justify-between gap-2">
          ...
          <span className="px-2.5 sm:px-3 py-0.5 sm:py-1 rounded-lg sm:rounded-xl bg-[#F8FAFC] dark:bg-[#1E1F2A] border border-[#E2E8F0] dark:border-[#2C2E3E] text-[10px] sm:text-xs font-mono font-black text-amber-600 dark:text-amber-400 tabular-nums shrink-0">
