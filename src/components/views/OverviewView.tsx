  ...
  return (
    <div className="space-y-3.5 sm:space-y-5 pb-28 sm:pb-20">
      ...
      <div className="relative overflow-hidden rounded-2xl sm:rounded-3xl p-3.5 sm:p-6 bg-gradient-to-br from-white via-slate-50/90 to-white dark:from-[#181926]/90 dark:via-[#141522]/85 dark:to-[#0F1019]/95 backdrop-blur-xl border border-slate-200/90 dark:border-[#272738]/80 shadow-elevated-card print:p-0 print:border-none print:shadow-none">
        ...
        {/* Ambient Glow Orbs */}
        <div className="absolute -top-12 -right-12 w-48 sm:w-64 h-48 sm:h-64 rounded-full bg-gradient-to-br from-[#2563EB]/10 to-[#3B82F6]/10 dark:from-[#7AA2F7]/20 dark:to-[#8B5CF6]/15 blur-3xl pointer-events-none print:hidden" />
        <div className="absolute -bottom-8 -left-8 w-36 sm:w-44 h-36 sm:h-44 rounded-full bg-amber-500/10 dark:bg-cyan-500/10 blur-2xl pointer-events-none print:hidden" />
          ...
          <div className="flex items-center justify-between gap-1.5 sm:gap-2">
            ...
            <div className="flex items-center gap-1 sm:gap-1.5 shrink-0">
              {profile.currentStreak > 0 && (
                <div 
                  className="flex items-center gap-1 px-2 sm:px-2.5 py-0.5 sm:py-1 rounded-lg sm:rounded-xl bg-gradient-to-r from-amber-500/15 to-orange-500/15 border border-amber-500/30 text-amber-600 dark:text-amber-400 text-[10px] sm:text-[11px] font-mono font-black tabular-nums shadow-xs"
              ...
              <div 
                className="flex items-center gap-1 px-2 sm:px-2.5 py-0.5 sm:py-1 rounded-lg sm:rounded-xl bg-blue-500/10 dark:bg-[#7AA2F7]/15 border border-blue-500/20 dark:border-[#7AA2F7]/30 text-[#2563EB] dark:text-[#7AA2F7] text-[10px] sm:text-[11px] font-mono font-black tabular-nums shadow-xs"
              ...
              <div 
                className="flex items-center gap-1 px-2 sm:px-2.5 py-0.5 sm:py-1 rounded-lg sm:rounded-xl bg-purple-500/10 dark:bg-purple-500/15 border border-purple-500/25 text-purple-700 dark:text-purple-300 text-[10px] sm:text-[11px] font-bold shadow-xs"
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2.5 sm:gap-3 pt-0.5">
            <div className="min-w-0">
              <h1 className="text-lg sm:text-2xl font-black text-slate-900 dark:text-[#F5F5F7] tracking-tight leading-tight flex items-center gap-1.5 sm:gap-2 flex-wrap">
                ...
                <span className="inline-flex items-center justify-center w-5 sm:w-6 h-5 sm:h-6 rounded-full bg-amber-400/20 text-amber-500 border border-amber-400/30 text-[10px] sm:text-xs shadow-xs" title="Verified Aspirant">
                  ✨
                </span>
              </h1>
            ...
            <div className="grid grid-cols-2 gap-2 sm:flex sm:items-center sm:gap-2 shrink-0 no-print mt-1.5 sm:mt-0">
              ...
              <button
                ...
                className="w-full sm:w-auto justify-center px-3 py-2 rounded-xl bg-white dark:bg-[#20212F] border border-slate-200 dark:border-[#2E2F40] text-slate-800 dark:text-[#E2E8F0] text-xs sm:text-[13px] font-bold shadow-xs hover:border-[#2563EB] dark:hover:border-[#7AA2F7] active:scale-95 transition-all flex items-center gap-1.5 cursor-pointer tap-bounce"
      ...
      <div className="relative rounded-2xl sm:rounded-3xl overflow-hidden border border-[#E2E8F0] dark:border-[#272730] shadow-sm bg-[#0B0F19] group print:hidden">
        <div className="relative w-full aspect-[2.3/1] sm:aspect-[21/9] sm:max-h-[340px] overflow-hidden">
          ...
          <div className="absolute bottom-2 left-2 right-2 sm:bottom-3.5 sm:left-4 sm:right-4 flex items-center justify-between gap-1.5 sm:gap-2 pointer-events-none">
            <div className="flex items-center gap-1.5 sm:gap-2 px-2 sm:px-3 py-1 sm:py-1.5 rounded-lg sm:rounded-xl bg-black/75 backdrop-blur-md border border-white/15 text-white shadow-lg min-w-0">
            ...
            <div className="flex items-center gap-1 sm:gap-1.5 px-2 sm:px-3 py-1 sm:py-1.5 rounded-lg sm:rounded-xl bg-[#FACC15]/20 backdrop-blur-md border border-[#FACC15]/30 text-[#FACC15] text-[10px] sm:text-[13px] font-bold shadow-lg shrink-0">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-3 sm:gap-4">
        ...
        <div className="md:col-span-7 p-3.5 sm:p-6 rounded-2xl sm:rounded-3xl bg-white dark:bg-[#151620] border border-[#E2E8F0] dark:border-[#272730] shadow-subtle-depth flex flex-col justify-between relative overflow-hidden space-y-3.5 sm:space-y-4">
          ...
          <div className="relative z-10 flex items-center justify-between gap-3 pb-3 border-b border-[#EEEEE8] dark:border-[#242533]">
            ...
            <div className="flex items-center gap-1.5 px-2.5 sm:px-3 py-1 rounded-xl bg-[#F8FAFC] dark:bg-[#1E1F2A] border border-[#E2E8F0] dark:border-[#2E3044] shadow-2xs shrink-0">
          ...
          <div className="relative z-10 flex flex-col sm:flex-row items-center gap-4 sm:gap-5">
            ...
            <div className="relative w-28 h-28 sm:w-36 sm:h-36 flex items-center justify-center shrink-0">
              ...
              <div className="absolute flex flex-col items-center justify-center text-center">
                <span className="text-2xl sm:text-4xl font-black tabular-nums tracking-tight text-[#11120F] dark:text-[#F5F5F7] font-mono">
        ...
        <div className="md:col-span-5 p-3.5 sm:p-6 rounded-2xl sm:rounded-3xl bg-white dark:bg-[#151620] border border-[#E2E8F0] dark:border-[#272730] shadow-subtle-depth flex flex-col justify-between space-y-3 relative overflow-hidden">
          ...
          <div className="relative z-10 flex items-center justify-between gap-2 pb-3 border-b border-[#EEEEE8] dark:border-[#242533]">
            ...
            <button
              ...
              className="flex items-center gap-1 px-2.5 sm:px-3 py-1.5 rounded-xl bg-[#F8FAFC] dark:bg-[#1E1F2A] border border-[#E2E8F0] dark:border-[#2E3044] text-[#65675F] dark:text-[#CBD5E1] hover:text-[#2563EB] dark:hover:text-[#7AA2F7] hover:border-[#2563EB] dark:hover:border-[#7AA2F7] text-xs font-bold transition-all cursor-pointer shadow-2xs active:scale-95 tap-bounce"
        ...
        <div className="p-3.5 sm:p-6 rounded-2xl sm:rounded-3xl bg-white dark:bg-[#151620] border border-[#E2E8F0] dark:border-[#272730] shadow-subtle-depth space-y-3 sm:space-y-4 relative overflow-hidden">
          ...
          <div className="relative z-10 flex items-center justify-between gap-3 pb-3 border-b border-[#EEEEE8] dark:border-[#242533]">
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-2.5 sm:px-3 py-1.5 rounded-xl bg-[#F8FAFC] dark:bg-[#1E1F2A] border border-[#E2E8F0] dark:border-[#2E3044] text-[#65675F] dark:text-[#CBD5E1] hover:text-[#2563EB] dark:hover:text-[#7AA2F7] hover:border-[#2563EB] dark:hover:border-[#7AA2F7] text-xs font-bold transition-all cursor-pointer shadow-2xs active:scale-95 tap-bounce"
            >
              <span>View All</span>
          ...
          <div className="relative z-10 grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-3">
            {platforms.slice(0, 4).map(plat => (
              <div
                ...
                className="p-2.5 sm:p-3.5 rounded-xl sm:rounded-2xl bg-[#F8FAFC] dark:bg-[#1B1C28] border border-[#E2E8F0] dark:border-[#2A2C3E] hover:border-indigo-500/50 dark:hover:border-indigo-400/50 transition-all duration-200 cursor-pointer flex items-center gap-2.5 sm:gap-3 group shadow-2xs hover:shadow-md active:scale-[0.97] tap-bounce"
              >
                <div
                  className="w-8 sm:w-9 h-8 sm:h-9 rounded-lg sm:rounded-xl flex items-center justify-center text-sm sm:text-base shadow-sm border border-white/20 shrink-0 transition-transform group-hover:scale-105"
      ...
      <div className="p-3.5 sm:p-6 rounded-2xl sm:rounded-3xl bg-white dark:bg-[#151620] border border-[#E2E8F0] dark:border-[#272730] shadow-subtle-depth space-y-3.5 sm:space-y-4 print:p-0 print:border-none print:shadow-none">
        ...
        <div className="flex items-center justify-between gap-3 pb-3 border-b border-[#EEEEE8] dark:border-[#242533]">
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-2.5 sm:px-3 py-1.5 rounded-xl bg-[#F8FAFC] dark:bg-[#1E1F2A] border border-[#E2E8F0] dark:border-[#2E3044] text-[#65675F] dark:text-[#CBD5E1] hover:text-[#2563EB] dark:hover:text-[#7AA2F7] hover:border-[#2563EB] dark:hover:border-[#7AA2F7] text-xs font-bold transition-all cursor-pointer shadow-2xs active:scale-95 shrink-0 tap-bounce no-print"
          >
          ...
          {subjectStats.map(subj => {
            ...
            return (
              <div
                ...
                className="p-3 sm:p-4 rounded-xl sm:rounded-2xl bg-[#F8FAFC] dark:bg-[#1B1C28] border border-[#E2E8F0] dark:border-[#2A2C3E] hover:border-[#2563EB] dark:hover:border-[#7AA2F7] transition-all duration-200 shadow-2xs hover:shadow-md cursor-pointer space-y-2.5 sm:space-y-3 group active:scale-[0.98] relative overflow-hidden tap-bounce print-avoid-break print:border print:border-black print:rounded-lg"
              >
                {/* Subject Header Row */}
