...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <aside className="hidden md:flex flex-col w-64 h-screen sticky top-0 bg-[#F7F6F0] dark:bg-[#0B0B0D] border-r border-[#D8D8CF] dark:border-[#272730] p-4 justify-between transition-colors z-30 shrink-0 select-none overflow-y-auto">
